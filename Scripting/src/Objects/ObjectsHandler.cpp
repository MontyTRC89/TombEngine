...
ObjectsHandler::ObjectsHandler(sol::state* lua, sol::table & parent) : LuaHandler{ lua }
{
	...
	*/
	m_lua->set_function(ScriptReserved_GetItemByName, &ObjectsHandler::GetByName<Moveable, ScriptReserved_ItemInfo>, this);
	...
	*/
	m_lua->set_function(ScriptReserved_GetMeshByName, &ObjectsHandler::GetByName<Static, ScriptReserved_MeshInfo>, this);
...
{
	m_lua->set("Lara", Moveable(Lara.itemNumber, false));
}
