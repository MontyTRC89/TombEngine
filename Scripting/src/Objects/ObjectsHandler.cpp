...
ObjectsHandler::ObjectsHandler(sol::state* lua, sol::table & parent) : LuaHandler{ lua }
{
	...
	*/
	m_table_objects.set_function(ScriptReserved_GetCameraByName, &ObjectsHandler::GetByName<GameScriptCameraInfo, ScriptReserved_CameraInfo>, this);
	...
	*/
	...
	Moveable::Register(m_lua, m_table_objects);
