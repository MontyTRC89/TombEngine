...
static constexpr char const ScriptReserved_GetRotationY[]		= "GetRotationY";
static constexpr char const ScriptReserved_SetRotationY[]		= "SetRotationY";
...
static constexpr char const ScriptReserved_GetValid[]			= "GetValid";
