...
//{
	...
	constexpr inline auto PI_DIV_2	= PI / 4;
	...
	constexpr inline auto HLF_BLOCK_UNIT = BLOCK_UNIT / 2;
	constexpr inline auto QTR_BLOCK_UNIT = BLOCK_UNIT / 4;
	constexpr inline auto BLOCK			 = [](auto x) { return int(BLOCK_UNIT * x); };
	constexpr inline auto HLF_BLOCK		 = [](auto x) { return int(HLF_BLOCK_UNIT * x); };
