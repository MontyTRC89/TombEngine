...
//{
	...
	public:
		...
		void			   Lerp(const EulerAngles& eulersTo, float alpha = 1.0f, short epsilon = 3);
		static EulerAngles Lerp(const EulerAngles& eulersFrom, const EulerAngles& eulersTo, float alpha = 1.0f, short epsilon = 3);
	...
	private:
		...
		static short Lerp(short angleFrom, short angleTo, float alpha = 1.0f, short epsilon = 3);
