...
namespace TEN::Renderer
{
	...
	void Renderer11::RenderOptionsMenu(Menu menu, int initialY)
	{
		...
		case Menu::OtherSettings:
			...
			// Inverse kinematics
			AddString(MenuLeftSideEntry, y, g_GameFlow->GetString(STRING_ENABLE_IK), PRINTSTRING_COLOR_ORANGE, SF(titleOption == 5));
			AddString(MenuRightSideEntry, y, Str_Enabled(g_Gui.GetCurrentSettings().Configuration.EnableIK), PRINTSTRING_COLOR_WHITE, SF(titleOption == 5));
			GetNextLinePosition(&y);
