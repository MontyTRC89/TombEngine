#include "framework.h"
#include "Renderer/Graphics/RenderTargetCubeArray.h"
#include "Renderer/Utils.h"

namespace TEN::Renderer::Graphics
{
	RenderTargetCubeArray::RenderTargetCubeArray(ID3D11Device* device, int resolution, int numCubes, DXGI_FORMAT colorFormat,DXGI_FORMAT depthFormat) 
		: NumCubes(numCubes), Resolution(resolution), Viewport(CreateViewport(resolution))
	{
