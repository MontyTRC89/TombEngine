...
enum SMAAMode { MODE_SMAA_1X, MODE_SMAA_T2X, MODE_SMAA_S2X, MODE_SMAA_4X, MODE_SMAA_COUNT = MODE_SMAA_4X };
enum SMAAPreset { SMAA_PRESET_LOW, SMAA_PRESET_MEDIUM, SMAA_PRESET_HIGH, SMAA_PRESET_ULTRA, SMAA_PRESET_CUSTOM, SMAA_PRESET_COUNT = SMAA_PRESET_CUSTOM };
enum SMAAInput { SMAA_INPUT_LUMA, SMAA_INPUT_COLOR, SMAA_INPUT_DEPTH, SMAA_INPUT_COUNT = SMAA_INPUT_DEPTH };
