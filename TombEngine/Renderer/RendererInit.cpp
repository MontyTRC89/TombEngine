...
void TEN::Renderer::Renderer::Initialize(int w, int h, bool windowed, HWND handle)
{
...
void TEN::Renderer::Renderer::InitializeSky()
{
...
void TEN::Renderer::Renderer::InitializeScreen(int w, int h, HWND handle, bool reset)
{
...
void TEN::Renderer::Renderer::Create()
{
