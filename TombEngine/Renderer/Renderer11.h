...
namespace TEN::Renderer
{
	...
	public:
		...
		void AddDebugReticle(const Vector3& center, const Quaternion& orient, float radius, const Color& color, RendererDebugPage page = RendererDebugPage::None, bool isWireframe = true);
