...
namespace TEN::Renderer
{
	...
	void Renderer::RenderOptionsMenu(Menu menu, int initialY)
	{
		...
		case Menu::Controls:
			...
			// Auto grab
			AddString(MenuLeftSideEntry, y, g_GameFlow->GetString(STRING_AUTO_GRAB), PRINTSTRING_COLOR_ORANGE, SF(titleOption == 3));
			AddString(MenuRightSideEntry, y, Str_Enabled(g_Gui.GetCurrentSettings().Configuration.EnableAutoGrab), PRINTSTRING_COLOR_WHITE, SF(titleOption == 3));
			GetNextLinePosition(&y);

			// Auto targeting
			AddString(MenuLeftSideEntry, y, g_GameFlow->GetString(STRING_AUTO_TARGETING), PRINTSTRING_COLOR_ORANGE, SF(titleOption == 4));
			...
			AddString(MenuLeftSideEntry, y, "Invert Camera X Axis", PRINTSTRING_COLOR_ORANGE, SF(titleOption == 7));
			AddString(MenuRightSideEntry, y, Str_Enabled(g_Gui.GetCurrentSettings().Configuration.InvertCameraXAxis), PRINTSTRING_COLOR_WHITE, SF(titleOption == 7));
			GetNextLinePosition(&y);

			// Invert camera Y axis
			AddString(MenuLeftSideEntry, y, "Invert Camera Y Axis", PRINTSTRING_COLOR_ORANGE, SF(titleOption == 8));
			AddString(MenuRightSideEntry, y, Str_Enabled(g_Gui.GetCurrentSettings().Configuration.InvertCameraYAxis), PRINTSTRING_COLOR_WHITE, SF(titleOption == 8));
			GetNextLinePosition(&y);
