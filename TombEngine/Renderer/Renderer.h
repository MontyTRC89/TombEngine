...
namespace TEN::Renderer
{
	...
	private:
		...
		void UpdateAnimation(RendererItem* rendererItem, RendererObject& rendererObject, const FrameInterpData& frameInterp, int mask, bool useObjectWorldRotation = false, const MoveableAnimBlendData* = nullptr);
