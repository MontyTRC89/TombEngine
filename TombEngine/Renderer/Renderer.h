...
namespace TEN::Renderer
{
	...
	public:
		...
		void AddDebugBox(const std::array<Vector3, BOX_CORNER_COUNT>& corners, const Color& color, RendererDebugPage page = RendererDebugPage::None, bool isWireframe = true);
