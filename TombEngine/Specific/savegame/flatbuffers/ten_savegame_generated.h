...
struct SaveGame FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_SOUNDTRACKS = 58,
    VT_CD_FLAGS = 60,
    VT_POSTPROCESS_MODE = 62,
    VT_POSTPROCESS_STRENGTH = 64,
    VT_POSTPROCESS_TINT = 66,
    VT_ROPE = 68,
    VT_PENDULUM = 70,
    VT_ALTERNATE_PENDULUM = 72,
    VT_VOLUMES = 74,
    VT_GLOBAL_EVENT_SETS = 76,
    VT_VOLUME_EVENT_SETS = 78,
    VT_SCRIPT_VARS = 80,
    ...
    VT_CALLBACKS_PRE_LOOP = 98,
    VT_CALLBACKS_POST_LOOP = 100
  };
