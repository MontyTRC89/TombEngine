...
EulerAngles GetOrientBetweenPoints(Vector3i origin, Vector3i target)
{
...
Vector3i TranslateVector(Vector3i& vector, short angle, float forward, float down, float right)
{
...
Vector3i TranslateVector(Vector3i& vector, EulerAngles& orient, float distance)
{
...
Vector3i TranslateVector(Vector3i& vector, Vector3& direction, float distance)
{
