...
Vector3 TranslateVector(Vector3 vector, short yOrient, float forward, float vertical = 0.0f, float lateral = 0.0f);
Vector3Int TranslateVector(Vector3Int vector, short yOrient, float forward, float vertical = 0.0f, float lateral = 0.0f);
