...
namespace TEN::Entities::Vehicles
{
	...
	enum MotorbikeAnim
	{
		...
		MOTORBIKE_ANIM_IMPACT_FRONT = 11,
		MOTORBIKE_ANIM_IMPACT_BACK = 12,
		MOTORBIKE_ANIM_IMPACT_LEFT = 13,
		MOTORBIKE_ANIM_IMPACT_RIGHT = 14,
				...
				laraItem.Animation.ActiveState == MOTORBIKE_STATE_NONE_6)
			{
				...
				case MOTORBIKE_STATE_IDLE:
					...
					else
					{
						...
						{
							if (IsHeld(In::Accelerate) && !(TrInput & VEHICLE_IN_BRAKE))
	...
	int MotorbikeDynamics(ItemInfo& motorbikeItem, ItemInfo& laraItem)
	{
		...
		auto prevPointFrontLeft = GetVehicleCollision(motorbikeItem, MOTORBIKE_FRONT, -MOTORBIKE_SIDE, true);
		auto prevPointFrontRight = GetVehicleCollision(motorbikeItem, MOTORBIKE_FRONT, CLICK(0.5f), true);
		auto prevPointBackLeft = GetVehicleCollision(motorbikeItem, -MOTORBIKE_FRONT, -MOTORBIKE_SIDE, true);
