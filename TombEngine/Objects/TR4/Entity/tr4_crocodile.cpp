...
namespace TEN::Entities::TR4
{
	...
	#define CROC_STATE_WALK_FORWARD_ANGLE Angle::DegToRad(3.0f)
	#define CROC_SWIM_ANGLE Angle::DegToRad(3.0f)
	#define CROC_STATE_RUN_FORWARD_ANGLE Angle::DegToRad(5.0f)
