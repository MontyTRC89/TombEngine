...
namespace TEN::Entities::TR4
{
	...
	#define CROC_STATE_WALK_TURN_RATE_MAX Angle::DegToRad(3.0f)
	#define CROC_STATE_RUN_TURN_RATE_MAX  Angle::DegToRad(5.0f)
	#define CROC_STATE_SWIM_TURN_RATE_MAX Angle::DegToRad(3.0f)
