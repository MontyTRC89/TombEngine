...
namespace TEN::Entities::TR4
{
	...
	static void RotateHeadToTarget(ItemInfo* item, CreatureInfo* creature, int joint, float& headAngle)
	{
	...
	static void GetTargetPosition(ItemInfo* item, PHD_3DPOS* target)
	{
		...
		auto angles = GetOrientBetweenPoints(start.ToVector3(), end.ToVector3());
		target->Position = end;
