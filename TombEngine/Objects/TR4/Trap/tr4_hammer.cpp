                ...
                if (item->TriggerFlags == 2)
                {
                    ...
                    if (targetItem != NO_ITEM)
                    {
                        ...
                        for (; targetItem != NO_ITEM; targetItem = target->NextItem)
                        {
                            ...
                            if (target->ObjectNumber == ID_OBELISK && target->Pose.Orientation.y == Angle::DegToRad(-270) &&
                                g_Level.Items[target->ItemFlags[0]].Pose.Orientation.y == Angle::DegToRad(90) &&
                                g_Level.Items[target->ItemFlags[1]].Pose.Orientation.y == 0.0f)
                            {
