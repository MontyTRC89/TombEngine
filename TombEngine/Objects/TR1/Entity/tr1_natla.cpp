...
namespace TEN::Entities::TR1
{
	...
	#define NATLA_TURN_NEAR_DEATH_SPEED Angle::DegToRad(6.0f)
	#define NATLA_TURN_SPEED Angle::DegToRad(5.0f)
	#define NATLA_FLY_ANGLE_SPEED Angle::DegToRad(5.0f)
	#define NATLA_SHOOT_ANGLE Angle::DegToRad(30.0f)
