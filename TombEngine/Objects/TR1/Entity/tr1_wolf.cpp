...
namespace TEN::Entities::TR1
{
	...
	#define WOLF_WALK_TURN_RATE_MAX	 Angle::DegToRad(2.0f)
	#define WOLF_RUN_TURN_RATE_MAX	 Angle::DegToRad(5.0f)
	#define WOLF_STALK_TURN_RATE_MAX Angle::DegToRad(2.0f)
