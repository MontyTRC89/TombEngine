...
namespace TEN::Entities::Vehicles
{
	...
	#define BGUN_TURN_RATE_ACCEL Angle::DegToRad(0.5f)
	#define BGUN_TURN_RATE_MAX	 Angle::DegToRad(4.0f)
	#define BGUN_X_ORIENT_STEP	 (Angle::DegToRad(80.0f) / BGUN_X_ORIENT_NUM_FRAMES)
	#define BGUN_X_ORIENT_MAX	 Angle::DegToRad(40.0f)
	...
	void BigGunFire(ItemInfo* bigGunItem, ItemInfo* laraItem)
	{
		...
		if (itemNumber != NO_ITEM)
		{
			...
			projectileItem->Pose.Orientation = EulerAngles(
				-((bigGun->XOrientFrame - 32) * Angle::DegToRad(1.0f)),
	...
	bool BigGunControl(ItemInfo* laraItem, CollisionInfo* coll)
	{
		...
		Camera.targetElevation = -(bigGun->Rotation.x + Angle::DegToRad(15.0f));
