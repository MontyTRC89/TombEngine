...
namespace TEN::Entities::Vehicles
{
	...
	static void FireUPVHarpoon(ItemInfo* UPVItem, ItemInfo* laraItem)
	{
		...
		if (itemNumber != NO_ITEM)
		{
			...
			// TODO: Huh?
			harpoonItem->Animation.Velocity.y = -UPV_HARPOON_VELOCITY * sin(harpoonItem->Pose.Orientation.x);
			harpoonItem->Animation.Velocity.z = UPV_HARPOON_VELOCITY * cos(harpoonItem->Pose.Orientation.x);
