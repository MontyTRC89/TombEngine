...
namespace TEN::Entities::Creatures::TR3
{
	...
	#define CIVVY_WALK_TURN_RATE_MAX Angle::DegToRad(5.0f)
	#define CIVVY_RUN_TURN_RATE_MAX	 Angle::DegToRad(6.0f)
	...
	void CivvyControl(short itemNumber)
	{
		...
		else
		{
			...
			else
			{
				...
				laraAI.angle = atan2(laraDz, laraDx) - item->Pose.Orientation.y;
			...
			if (creature->Enemy == LaraItem &&
				...
				AI.enemyFacing < Angle::DegToRad(67.0f) &&
				AI.enemyFacing > Angle::DegToRad(-67.0f))
			{
