...
namespace TEN::Entities::Creatures::TR3
{
	...
	#define TIGER_WALK_TURN_RATE_MAX		  Angle::DegToRad(3.0f)
	#define TIGER_RUN_TURN_RATE_MAX			  Angle::DegToRad(6.0f)
	#define TIGER_POUNCE_ATTACK_TURN_RATE_MAX Angle::DegToRad(3.0f)
