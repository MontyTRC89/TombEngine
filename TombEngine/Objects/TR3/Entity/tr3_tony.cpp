...
namespace TEN::Entities::Creatures::TR3
{
	...
	#define TONY_TURN Angle::DegToRad(2.0f)
	...
	static void TriggerFireBall(ItemInfo* item, TonyFlameType type, Vector3Int* laraPos, short roomNumber, float angle, int zdVelocity)
	{
		TonyFlame flame;
