...
namespace TEN::Entities::TR3
{
	...
	#define RAPTOR_WALK_TURN_RATE_MAX	Angle::DegToRad(2.0f)
	#define RAPTOR_RUN_TURN_RATE_MAX	Angle::DegToRad(2.0f)
	#define RAPTOR_ATTACK_TURN_RATE_MAX Angle::DegToRad(2.0f)
