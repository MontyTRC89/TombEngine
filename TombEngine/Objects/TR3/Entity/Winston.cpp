...
namespace TEN::Entities::Creatures::TR3
{
	...
	enum WinstonAnim
	{
		...
		WINSTON_ANIM_MED_HEIGHT_GUARD = 5,
		WINSTON_ANIM_MED_HEIGHT_RECOIL = 6,
		WINSTON_ANIM_MED_HEIGHT_RECOIL_TO_IDLE = 7,
		WINSTON_ANIM_MED_TO_LOW_GUARD = 8,
		WINSTON_ANIM_LOW_GUARD = 9,
		WINSTON_ANIM_LOW_RECOIL = 10,
		WINSTON_ANIM_LOW_TO_MED_GUARD = 11,
		WINSTON_ANIM_MED_TO_HIGH_GUARD = 12,
		WINSTON_ANIM_HIGH_GUARD = 13,
		WINSTON_ANIM_HIGH_RECOIL = 14,
		WINSTON_ANIM_HIGH_TO_MED_GUARD = 15,
