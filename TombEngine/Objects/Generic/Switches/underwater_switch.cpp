...
{ 
	const InteractionBasis UnderwaterSwitchBounds =
	{
		GameBoundingBox(
			-SECTOR(1), SECTOR(1),
			-SECTOR(1), SECTOR(1),
	...
	const InteractionBasis CeilingUnderwaterSwitchBounds1 =
	{
		GameBoundingBox(
			-CLICK(1), CLICK(1),
	...
	const InteractionBasis CeilingUnderwaterSwitchBounds2 =
	{
		GameBoundingBox(
			-CLICK(1), CLICK(1),
			-SECTOR(1.25f), -SECTOR(0.5f),
