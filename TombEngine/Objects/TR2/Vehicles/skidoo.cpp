...
namespace TEN::Entities::Vehicles
{
	...
	#define SKIDOO_TURN_RATE_ACCEL			Angle::DegToRad(2.5f)
	#define SKIDOO_TURN_RATE_DECEL			Angle::DegToRad(2.0f)
	#define SKIDOO_TURN_RATE_MAX			Angle::DegToRad(6.0f)
	#define SKIDOO_MOMENTUM_TURN_RATE_ACCEL	Angle::DegToRad(3.0f)
	#define SKIDOO_MOMENTUM_TURN_RATE_MAX	Angle::DegToRad(150.0f)
	...
	bool SkidooControl(ItemInfo* laraItem, CollisionInfo* coll)
	{
		...
		skidooItem->Animation.Velocity.z = 0.0f;// DoVehicleWaterMovement(skidooItem, laraItem, skidooItem->Animation.Velocity, SKIDOO_RADIUS, &skidoo->TurnRate);
