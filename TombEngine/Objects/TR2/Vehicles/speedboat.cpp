...
namespace TEN::Entities::Vehicles
{
	...
	int SpeedboatDynamics(short itemNumber, ItemInfo* laraItem)
	{
		...
		speedboatItem->Pose.Position.x += speedboatItem->Animation.Velocity * sin(speedboatItem->Pose.Orientation.y);
		speedboatItem->Pose.Position.z += speedboatItem->Animation.Velocity * cos(speedboatItem->Pose.Orientation.y);
