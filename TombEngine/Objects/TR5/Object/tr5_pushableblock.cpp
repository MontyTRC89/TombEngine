...
namespace TEN::Entities::Generic
{
	...
	void InitializePushablesSoundsMap()
	{
		PushablesSoundsMap =
		{
			{FLOOR_MATERIAL::Mud,		PushablesSounds(SFX_TEN_PUSHABLES_MOVE_MUD, SFX_TEN_PUSHABLES_STOP_MUD, SFX_TEN_PUSHABLES_COLLIDE_MUD)},
			{FLOOR_MATERIAL::Snow,		PushablesSounds(SFX_TEN_PUSHABLES_MOVE_SNOW, SFX_TEN_PUSHABLES_STOP_SNOW, SFX_TEN_PUSHABLES_COLLIDE_SNOW)},
			{FLOOR_MATERIAL::Sand,		PushablesSounds(SFX_TEN_PUSHABLES_MOVE_SAND, SFX_TEN_PUSHABLES_STOP_SAND, SFX_TEN_PUSHABLES_COLLIDE_SAND)},
			{FLOOR_MATERIAL::Gravel,	PushablesSounds(SFX_TEN_PUSHABLES_MOVE_GRAVEL, SFX_TEN_PUSHABLES_STOP_GRAVEL, SFX_TEN_PUSHABLES_COLLIDE_GRAVEL)},
			{FLOOR_MATERIAL::Ice,		PushablesSounds(SFX_TEN_PUSHABLES_MOVE_ICE, SFX_TEN_PUSHABLES_STOP_ICE, SFX_TEN_PUSHABLES_COLLIDE_ICE)},
			{FLOOR_MATERIAL::Water,		PushablesSounds(SFX_TEN_PUSHABLES_MOVE_WATER, SFX_TEN_PUSHABLES_STOP_WATER, SFX_TEN_PUSHABLES_COLLIDE_WATER)},
			{FLOOR_MATERIAL::Stone,		PushablesSounds(SFX_TEN_PUSHABLES_STOP_MOVE_STONE, SFX_TEN_PUSHABLES_STOP_STONE, SFX_TEN_PUSHABLES_COLLIDE_STONE)},
			{FLOOR_MATERIAL::Wood,		PushablesSounds(SFX_TEN_PUSHABLES_MOVE_WOOD, SFX_TEN_PUSHABLES_STOP_WOOD, SFX_TEN_PUSHABLES_COLLIDE_WOOD)},
			{FLOOR_MATERIAL::Metal,		PushablesSounds(SFX_TEN_PUSHABLES_MOVE_METAL, SFX_TEN_PUSHABLES_STOP_METAL, SFX_TEN_PUSHABLES_COLLIDE_METAL)},
			{FLOOR_MATERIAL::Marble,	PushablesSounds(SFX_TEN_PUSHABLES_MOVE_MARBLE, SFX_TEN_PUSHABLES_STOP_MARBLE, SFX_TEN_PUSHABLES_COLLIDE_MARBLE)},
			{FLOOR_MATERIAL::Grass,		PushablesSounds(SFX_TEN_PUSHABLES_MOVE_GRASS, SFX_TEN_PUSHABLES_STOP_GRASS, SFX_TEN_PUSHABLES_COLLIDE_GRASS)},
			{FLOOR_MATERIAL::Concrete,	PushablesSounds(SFX_TEN_PUSHABLES_MOVE_CONCRETE, SFX_TEN_PUSHABLES_STOP_CONCRETE, SFX_TEN_PUSHABLES_COLLIDE_CONCRETE)},
