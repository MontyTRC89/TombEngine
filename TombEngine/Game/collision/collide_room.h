...
CollisionResult GetCollision(ItemInfo* item, float angle, float forward, float up = 0.0f, float right = 0.0f);
CollisionResult GetCollision(Vector3Int pos, int roomNumber, float angle, float forward, float up = 0.0f, float right = 0.0f);
