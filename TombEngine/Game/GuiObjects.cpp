...
namespace TEN::Gui
{
    ...
    { ID_PISTOLS_AMMO_ITEM, 4, 0.5f, EulerAngles::Identity, OPT_USE, STRING_PISTOL_AMMO, NO_JOINT_BITS, INV_ROT_Y },
		{ ID_MAGNUMS_ITEM, 6, 0.5f, EulerAngles(ANGLE(244.0f), ANGLE(90.0f), ANGLE(276.0f)), OPT_EQUIP | OPT_COMBINABLE | OPT_CHOOSE_AMMO_MAGNUMS, STRING_MAGNUMS, NO_JOINT_BITS, INV_ROT_Y},
		{ ID_MAGNUMS_AMMO_ITEM, 4, 0.5f, EulerAngles::Zero, OPT_USE, STRING_MAGNUM_AMMO, NO_JOINT_BITS, INV_ROT_Y },
