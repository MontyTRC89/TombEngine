...
namespace TEN::Gui
{
	...
	InventoryObject InventoryObjectTable[INVENTORY_TABLE_SIZE] =
	{
		...
		{ ID_HK_AMMO_ITEM, 3, 0.5f, EulerAngles(0, ANGLE(90.0f), 0), OPT_USE, STRING_HK_RAPID_MODE, 3, INV_ROT_Y },
		{ ID_HK_AMMO_ITEM, 3, 0.5f, EulerAngles(0, ANGLE(90.0f), 0), OPT_USE, STRING_HK_BURST_MODE, 4, INV_ROT_Y },
		{ ID_HK_AMMO_ITEM, 3, 0.5f, EulerAngles(0, ANGLE(90.0f), 0), OPT_USE, STRING_HK_SNIPER_MODE, 5, INV_ROT_Y },
