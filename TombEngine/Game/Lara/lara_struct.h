...
enum LaraState
{
	...
	// TODO: Mount states unused for now.
	// Idea: object interaction dispatches can be dehardcoded by making a universal LS_OBJECT_INTERACT state. Every animation which 
	// allows object interaction may be given a link to it. Specific object code would do its collision assessment and call
	// HasStateDispatch(LS_OBJECT_INTERACT) where a valid interaction position is found, setting the target state to LS_LADDER_MOUNT_XYZ.
	// A dedicated object interaction script would check for this target state (perhaps using a table to optimise) and set the animation.
	LS_LADDER_MOUNT_TOP_FRONT = 177,
	LS_LADDER_MOUNT_TOP_BACK = 178,
	LS_LADDER_MOUNT_BOTTOM = 179,
	LS_LADDER_MOUNT_LEFT = 180,
	LS_LADDER_MOUNT_RIGHT = 181,
	LS_LADDER_MOUNT_JUMP_UP = 182,
	LS_LADDER_MOUNT_JUMP_REACH = 183,

	LS_LADDER_DISMOUNT_TOP = 184,
	LS_LADDER_DISMOUNT_BOTTOM = 185,
	LS_LADDER_DISMOUNT_LEFT = 186,
	LS_LADDER_DISMOUNT_RIGHT = 187,

	LS_POSITION_ALIGN = 188,
...
enum LaraAnim
{
	...
	// TR2
	LA_STAND_TO_WALL_CLIMB = 160,								// Stand > wall climb idle
	LA_WALL_CLIMB_UP = 161,										// Ascend wall (looped)
	LA_WALL_CLIMB_UP_LEFT_END = 162,							// Ascend wall > wall climb idle, left foot first
	LA_WALL_CLIMB_UP_RIGHT_END = 163,							// Ascend wall > wall climb idle, right foot first
	LA_WALL_CLIMB_IDLE = 164,									// Ladder idle (looped)
	LA_WALL_CLIMB_UP_START = 165,								// Ladder idle > ascend wall
	LA_WALL_CLIMB_DOWN_LEFT_END = 166,							// Descend wall > wall climb idle, left foot first
	LA_WALL_CLIMB_DOWN_RIGHT_END = 167,							// Descend wall > wall climb idle, right foot first
	LA_WALL_CLIMB_DOWN = 168,									// Descend wall (looped)
	LA_WALL_CLIMB_DOWN_START = 169,								// Ladder idle > descend wall
	LA_WALL_CLIMB_RIGHT = 170,									// Wall climb right (looped)
	LA_WALL_CLIMB_LEFT = 171,									// Wall climb left (looped)
	...
	LA_WALL_CLIMB_RIGHT_CORNER_INNER_END = 370,				// Ladder around inner right corner (2/2)
	...
	LA_WALL_CLIMB_TO_HANG_UNUSED = 395,						// Climb wall > hang
	...
	LA_MONKEY_TO_WALL_CLIMB_OVERHEAD_START = 487,			// Monkey idle > ladder idle, overhead (1/2)
	LA_MONKEY_TO_WALL_CLIMB_OVERHEAD_END = 488,				// Monkey idle > ladder idle, overhead (2/2)
	...
	LA_ONWATER_TO_WALL_CLIMB = 501,							// Tread water > ladder idle
	...
	LA_LADDER_IDLE = 569,
	LA_LADDER_IDLE_TO_UP_LEFT = 570,
	LA_LADDER_IDLE_TO_DOWN_RIGHT = 571,
	LA_LADDER_UP = 572,
	LA_LADDER_UP_TO_IDLE_LEFT = 573,
	LA_LADDER_UP_TO_IDLE_RIGHT = 574,
	LA_LADDER_DOWN = 575,
	LA_LADDER_DOWN_TO_IDLE_LEFT = 576,
	LA_LADDER_DOWN_TO_IDLE_RIGHT = 577,
	LA_LADDER_MOUNT_TOP_FRONT = 578,
	LA_LADDER_MOUNT_TOP_BACK = 579,
	LA_LADDER_MOUNT_BOTTOM = 580,
	LA_LADDER_MOUNT_LEFT = 581,
	LA_LADDER_MOUNT_RIGHT = 582,
	LA_LADDER_MOUNT_JUMP_UP = 583,
	LA_LADDER_MOUNT_JUMP_REACH = 584,
	LA_LADDER_DISMOUNT_TOP_LEFT = 585,
	LA_LADDER_DISMOUNT_TOP_RIGHT = 586,
	LA_LADDER_DISMOUNT_TOP_IDLE = 587,
	LA_LADDER_DISMOUNT_LEFT = 588,
	LA_LADDER_DISMOUNT_RIGHT = 589,
	LA_LADDER_DISMOUNT_BOTTOM_LEFT = 590,
	LA_LADDER_DISMOUNT_BOTTOM_RIGHT = 591,
	LA_LADDER_DISMOUNT_BOTTOM_IDLE = 592,
	LA_LADDER_DISMOUNT_JUMP_BACKWARD = 593,
	LA_LADDER_DISMOUNT_RELEASE = 594,
	LA_LADDER_DISMOUNT_FALL = 595,
	LA_LADDER_MOUNT_BOTTOM_TO_UP = 596, // TODO: A better root displacement method would avoid the need for this. -- Sezz 2022.10.29
