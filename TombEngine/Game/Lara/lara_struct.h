...
enum LaraExtraAnim
{
	LARA_EXTRA_ANIM_PULL_DAGGER_FROM_DRAGON = 0,
	LARA_EXTRA_ANIM_WAKE_UP = 1,
	LARA_EXTRA_ANIM_SPEAR_GUARDIAN_DEATH = 2,
	LARA_EXTRA_ANIM_TRAIN_DEATH_START = 3,
	LARA_EXTRA_ANIM_TREX_DEATH = 4,
	LARA_EXTRA_ANIM_SHARK_DEATH = 5,
	LARA_EXTRA_ANIM_GIANT_MUTANT_DEATH = 6,
	LARA_EXTRA_ANIM_SHIVA_DEATH = 7,
	LARA_EXTRA_ANIM_ACTIVATE_TNT_SWITCH = 8,
	LARA_EXTRA_ANIM_MIDAS_GOLD_SWITCH = 9,
	LARA_EXTRA_ANIM_MIDAS_DEATH = 10,
	LARA_EXTRA_ANIM_STRIKE_GONG = 11,
	LARA_EXTRA_ANIM_WILLARD_DEATH = 12,
	LARA_EXTRA_ANIM_TRAIN_DEATH_END = 13,
	LARA_EXTRA_ANIM_SETH_DEATH = 14
};
#pragma endregion
