...
void DoPlayerLegIK(ItemInfo& item, CollisionInfo* coll, float threshold = CLICK(1));
void DoPlayerArmIK(ItemInfo& item, CollisionInfo* coll, float threshold = CLICK(1));
