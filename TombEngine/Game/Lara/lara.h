...
#define LARA_TURN_RATE_ACCEL			ANGLE(2.25f)
#define LARA_CRAWL_MOVE_TURN_RATE_ACCEL	ANGLE(2.15f)
#define LARA_POLE_TURN_RATE_ACCEL		ANGLE(2.25f)
#define LARA_SUBSUIT_TURN_RATE_ACCEL	ANGLE(0.75f)

// Turn rate maxes
#define LARA_SLOW_TURN_RATE_MAX		   ANGLE(4.0f)
#define LARA_SLOW_MED_TURN_RATE_MAX	   ANGLE(5.0f)
#define LARA_MED_TURN_RATE_MAX		   ANGLE(6.0f)
#define LARA_MED_FAST_TURN_RATE_MAX	   ANGLE(7.0f)
#define LARA_FAST_TURN_RATE_MAX		   ANGLE(8.0f)
#define LARA_WADE_TURN_RATE_MAX		   ANGLE(5.5f)
#define LARA_SWAMP_TURN_RATE_MAX	   ANGLE(2.0f)
#define LARA_JUMP_TURN_RATE_MAX		   ANGLE(3.0f)
#define LARA_REACH_TURN_RATE_MAX	   ANGLE(1.3f)
#define LARA_SLIDE_TURN_RATE_MAX	   ANGLE(5.70f)
#define LARA_CRAWL_TURN_RATE_MAX	   ANGLE(2.0f)
#define LARA_CRAWL_MOVE_TURN_RATE_MAX  ANGLE(3.75f)
#define LARA_CROUCH_ROLL_TURN_RATE_MAX ANGLE(2.75f)
#define LARA_POLE_TURN_RATE_MAX		   ANGLE(4.5f)
