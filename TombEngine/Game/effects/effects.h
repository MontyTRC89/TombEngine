...
void TriggerDynamicPointLight(const Vector3& pos, const Color& color, float falloff, bool castShadows = false);
void TriggerDynamicSpotLight(const Vector3& pos, const Vector3& dir, const Color& color, float radius, float falloff, float distance, bool castShadows = false);
