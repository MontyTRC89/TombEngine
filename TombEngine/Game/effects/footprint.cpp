...
namespace Footprints {
	...
	void AddFootprint(ItemInfo* item, bool rightFoot)
	{
		...
		auto fx = SOUND_EFFECTS::SFX_TEN_LARA_FOOTSTEPS;
		// Choose material for footstep sound
		switch (floor->Material)
		{
		case FLOOR_MATERIAL::Concrete:
			fx = SOUND_EFFECTS::SFX_TEN_LARA_FOOTSTEPS;
			break;

		case FLOOR_MATERIAL::Grass:
			fx = SOUND_EFFECTS::SFX_TEN_LARA_FOOTSTEPS_GRASS;
			break;

		case FLOOR_MATERIAL::Gravel:
			fx = SOUND_EFFECTS::SFX_TEN_LARA_FOOTSTEPS_GRAVEL;
			break;

		case FLOOR_MATERIAL::Ice:
			fx = SOUND_EFFECTS::SFX_TEN_LARA_FOOTSTEPS_ICE;
			break;

		case FLOOR_MATERIAL::Marble:
			fx = SOUND_EFFECTS::SFX_TEN_LARA_FOOTSTEPS_MARBLE;
			break;

		case FLOOR_MATERIAL::Metal:
			fx = SOUND_EFFECTS::SFX_TEN_LARA_FOOTSTEPS_METAL;
			break;

		case FLOOR_MATERIAL::Mud:
			fx = SOUND_EFFECTS::SFX_TEN_LARA_FOOTSTEPS_MUD;
			break;
		...
		case FLOOR_MATERIAL::OldWood:
			fx = SOUND_EFFECTS::SFX_TEN_LARA_FOOTSTEPS_WOOD;
			break;

		case FLOOR_MATERIAL::Sand:
			fx = SOUND_EFFECTS::SFX_TEN_LARA_FOOSTEPS_SAND;
			break;

		case FLOOR_MATERIAL::Snow:
			fx = SOUND_EFFECTS::SFX_TEN_LARA_FOOTSTEPS_SNOW;
			break;
		...
		case FLOOR_MATERIAL::Water:
			fx = SOUND_EFFECTS::SFX_TEN_LARA_WET_FEET;
			break;
		...
		case FLOOR_MATERIAL::Custom_Sound_1:
			fx = SOUND_EFFECTS::SFX_TEN_CUSTOM_FOOTSTEP_SOUNDS_1;
		break;

		case FLOOR_MATERIAL::Custom_Sound_2:
			fx = SOUND_EFFECTS::SFX_TEN_CUSTOM_FOOTSTEP_SOUNDS_2;
		break; 
		
		case FLOOR_MATERIAL::Custom_Sound_3:
			fx = SOUND_EFFECTS::SFX_TEN_CUSTOM_FOOTSTEP_SOUNDS_3;
		break;
		
		case FLOOR_MATERIAL::Custom_Sound_4:
			fx = SOUND_EFFECTS::SFX_TEN_CUSTOM_FOOTSTEP_SOUNDS_4;
		break; 
		
		case FLOOR_MATERIAL::Custom_Sound_5:
			fx = SOUND_EFFECTS::SFX_TEN_CUSTOM_FOOTSTEP_SOUNDS_5;
			break;

		case FLOOR_MATERIAL::Custom_Sound_6:
			fx = SOUND_EFFECTS::SFX_TEN_CUSTOM_FOOTSTEP_SOUNDS_6;
			break;

		case FLOOR_MATERIAL::Custom_Sound_7:
			fx = SOUND_EFFECTS::SFX_TEN_CUSTOM_FOOTSTEP_SOUNDS_7;
			break;

		case FLOOR_MATERIAL::Custom_Sound_8:
			fx = SOUND_EFFECTS::SFX_TEN_CUSTOM_FOOTSTEP_SOUNDS_8;
			break;
		}

		// HACK: must be here until reference wad2 is revised
		if (fx != SOUND_EFFECTS::SFX_TEN_LARA_FOOTSTEPS)
