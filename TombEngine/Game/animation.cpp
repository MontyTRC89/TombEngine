...
void TranslateItem(ItemInfo* item, short angle, float forward, float up, float right)
{
	item->Pose.Position = TranslatePoint(item->Pose.Position, angle, forward, up, right);
}
