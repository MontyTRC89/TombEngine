...
InventoryObject inventry_objects_list[INVENTORY_TABLE_SIZE] =
{
	...
	{ID_PISTOLS_ITEM, 6, 0.5f, Angle::DegToRad(90), Angle::DegToRad(243.69873046875f), Angle::DegToRad(276.1328125), OPT_EQUIP | OPT_COMBINABLE | OPT_CHOOSEAMMO_PISTOLS, STRING_PISTOLS, NO_JOINT_BITS,  INV_ROT_Y},
	{ID_PISTOLS_AMMO_ITEM, 4, 0.5f, 0, Angle::DegToRad(90), 0, OPT_USE, STRING_PISTOLS_AMMO, NO_JOINT_BITS, INV_ROT_Y},
	{ID_UZI_ITEM, -4, 0.5f, Angle::DegToRad(-90) , Angle::DegToRad(135), Angle::DegToRad(90), OPT_EQUIP | OPT_COMBINABLE | OPT_CHOOSEAMMO_UZI, STRING_UZI , NO_JOINT_BITS, INV_ROT_Y},
	...
	{ID_SHOTGUN_AMMO1_ITEM, 0, 0.5f, Angle::DegToRad(90), 0, 0, OPT_USE, STRING_SHOTGUN_AMMO1, NO_JOINT_BITS, INV_ROT_Y},
	{ID_SHOTGUN_AMMO2_ITEM, 0, 0.5f, Angle::DegToRad(90), 0, 0, OPT_USE, STRING_SHOTGUN_AMMO2, NO_JOINT_BITS, INV_ROT_Y},
	...
	{ID_REVOLVER_AMMO_ITEM, 0, 0.5f, Angle::DegToRad(90), Angle::DegToRad(-16), 0, OPT_USE, STRING_REVOLVER_AMMO, NO_JOINT_BITS, INV_ROT_Y},
	...
	{ID_CROSSBOW_AMMO1_ITEM, 0, 0.5f, Angle::DegToRad(90), 0, 0, OPT_USE, STRING_CROSSBOW_AMMO1, NO_JOINT_BITS, INV_ROT_Y},
	{ID_CROSSBOW_AMMO2_ITEM, 0, 0.5f, Angle::DegToRad(90), 0, 0, OPT_USE, STRING_CROSSBOW_AMMO2, NO_JOINT_BITS, INV_ROT_Y},
	{ID_CROSSBOW_AMMO3_ITEM, 0, 0.5f, Angle::DegToRad(90), 0, 0, OPT_USE, STRING_CROSSBOW_AMMO3, NO_JOINT_BITS, INV_ROT_Y},
	{ID_HK_ITEM, 0, 0.5f, Angle::DegToRad(0), Angle::DegToRad(280), 0, OPT_EQUIP | OPT_COMBINABLE | OPT_CHOOSEAMMO_HK, STRING_HK, 1, INV_ROT_Y},
	{ID_HK_ITEM, 0, 0.5f, Angle::DegToRad(-45), Angle::DegToRad(280), 0, OPT_EQUIP | OPT_SEPERATABLE | OPT_CHOOSEAMMO_HK, STRING_HK_SILENCED, NO_JOINT_BITS, INV_ROT_Y},
	{ID_HK_AMMO_ITEM, 3, 0.5f, Angle::DegToRad(90), 0, 0, OPT_USE, STRING_HK_AMMO, 2},
	{ID_GRENADE_GUN_ITEM, 0, 0.5f, Angle::DegToRad(90), 0, Angle::DegToRad(65), OPT_EQUIP | OPT_COMBINABLE | OPT_CHOOSEAMMO_GRENADEGUN, STRING_GRENADE_LAUNCHER, NO_JOINT_BITS, INV_ROT_Y},
	{ID_GRENADE_AMMO1_ITEM, 3, 0.5f, Angle::DegToRad(90), 0, 0, OPT_USE, STRING_GRENADE_AMMO1, NO_JOINT_BITS, INV_ROT_Y},
	{ID_GRENADE_AMMO2_ITEM, 3, 0.5f, Angle::DegToRad(90), 0, 0, OPT_USE, STRING_GRENADE_AMMO2, NO_JOINT_BITS, INV_ROT_Y},
	{ID_GRENADE_AMMO3_ITEM, 3, 0.5f, Angle::DegToRad(90), 0, 0, OPT_USE, STRING_GRENADE_AMMO3, NO_JOINT_BITS, INV_ROT_Y},
	{ID_HARPOON_ITEM, 0, 0.5f, 0, Angle::DegToRad(-65), Angle::DegToRad(-20), OPT_EQUIP | OPT_COMBINABLE | OPT_CHOOSEAMMO_HARPOON, STRING_HARPOON_GUN, NO_JOINT_BITS, INV_ROT_Y},
	{ID_HARPOON_AMMO_ITEM, 3, 0.5f, 0, Angle::DegToRad(15), 0, OPT_USE, STRING_HARPOON_AMMO, NO_JOINT_BITS, INV_ROT_Y},
	{ID_ROCKET_LAUNCHER_ITEM, 0, 0.5f, Angle::DegToRad(180), Angle::DegToRad(80), 0, OPT_EQUIP | OPT_COMBINABLE | OPT_CHOOSEAMMO_ROCKET, STRING_ROCKET_LAUNCHER, NO_JOINT_BITS, INV_ROT_Y},
	{ID_ROCKET_LAUNCHER_AMMO_ITEM, 3, 0.5f, Angle::DegToRad(90), 0, Angle::DegToRad(15), OPT_USE, STRING_ROCKET_AMMO, NO_JOINT_BITS, INV_ROT_Y},

	// Misc

	{ID_LASERSIGHT_ITEM, 2, 0.5f, Angle::DegToRad(90), Angle::DegToRad(10), 0, OPT_USE | OPT_COMBINABLE, STRING_LASERSIGHT, NO_JOINT_BITS, INV_ROT_Y},
	{ID_SILENCER_ITEM, 1, 0.5f, 0, Angle::DegToRad(10), 0, OPT_USE | OPT_COMBINABLE, STRING_SILENCER, NO_JOINT_BITS, INV_ROT_Y},
	{ID_BIGMEDI_ITEM, 2, 0.7f, Angle::DegToRad(180), 0, 0, OPT_USE, STRING_LARGE_MEDIPACK, NO_JOINT_BITS, INV_ROT_Y},
	{ID_SMALLMEDI_ITEM, 0, 0.7f, Angle::DegToRad(180), Angle::DegToRad(112), 0, OPT_USE, STRING_SMALL_MEDIPACK, NO_JOINT_BITS, INV_ROT_Y},
	{ID_BINOCULARS_ITEM, -1, 0.5f, Angle::DegToRad(180), Angle::DegToRad(10), 0, OPT_USE, STRING_BINOCULARS, NO_JOINT_BITS, INV_ROT_Y},
	...
	{ID_WATERSKIN1_EMPTY, 2, 0.5f, 0, Angle::DegToRad(285), 0, OPT_USE | OPT_COMBINABLE, STRING_WATERSKIN_SMALL_EMPTY, NO_JOINT_BITS, INV_ROT_Y},
	{ID_WATERSKIN1_1, 2, 0.5f, 0, Angle::DegToRad(285), 0, OPT_USE | OPT_COMBINABLE, STRING_WATERSKIN_SMALL_1, NO_JOINT_BITS, INV_ROT_Y},
	{ID_WATERSKIN1_2, 2, 0.5f, 0, Angle::DegToRad(285), 0, OPT_USE | OPT_COMBINABLE, STRING_WATERSKIN_SMALL_2, NO_JOINT_BITS, INV_ROT_Y},
	{ID_WATERSKIN1_3, 2, 0.5f, 0, Angle::DegToRad(285), 0, OPT_USE | OPT_COMBINABLE, STRING_WATERSKIN_SMALL_3, NO_JOINT_BITS, INV_ROT_Y},
	{ID_WATERSKIN2_EMPTY, 2, 0.5f, 0, Angle::DegToRad(285), 0, OPT_USE | OPT_COMBINABLE, STRING_WATERSKIN_LARGE_EMPTY, NO_JOINT_BITS, INV_ROT_Y},
	{ID_WATERSKIN2_1, 2, 0.5f, 0, Angle::DegToRad(285), 0, OPT_USE | OPT_COMBINABLE, STRING_WATERSKIN_LARGE_1, NO_JOINT_BITS, INV_ROT_Y},
	{ID_WATERSKIN2_2, 2, 0.5f, 0, Angle::DegToRad(285), 0, OPT_USE | OPT_COMBINABLE, STRING_WATERSKIN_LARGE_2, NO_JOINT_BITS, INV_ROT_Y},
...
{
	if (*angle)
		*angle = Angle::InterpolateLinear(*angle, 0.0f, 0.25f / 2, Angle::DegToRad(0.1f));
}
...
void GuiController::DrawCompass()
{
	...
	float compass_speed = sin(compassNeedleAngle - LaraItem->Pose.Orientation.GetY());
	float compass_angle = (LaraItem->Pose.Orientation.GetY() + compass_speed) - Angle::DegToRad(180.0f);
