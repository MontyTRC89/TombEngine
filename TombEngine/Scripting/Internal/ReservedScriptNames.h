...
static constexpr char ScriptReserved_SetOnInitialised[]         = "SetOnInitialised";
...
static constexpr char ScriptReserved_SetOnUpdate[]              = "SetOnUpdate";
...
static constexpr char ScriptReserved_GetCreatureMood[]      = "GetCreatureMood";
static constexpr char ScriptReserved_CreatureMood[]         = "CreatureMood";
static constexpr char ScriptReserved_CreatureAIInfo[]       = "CreatureAIInfo";
static constexpr char ScriptReserved_CreatureAnimation[]    = "CreatureAnimation";
static constexpr char ScriptReserved_CreatureTurn[]         = "CreatureTurn";
static constexpr char ScriptReserved_CanCreatureJump[]      = "CanCreatureJump";
static constexpr char ScriptReserved_SetTurnSpeed[]         = "SetTurnSpeed";
static constexpr char ScriptReserved_IsCreatureActive[]     = "IsCreatureActive";
static constexpr char ScriptReserved_GetCreatureInfo[]      = "GetCreatureInfo";
static constexpr char ScriptReserved_IsRoomHasFlags[]       = "IsRoomHasFlags";
static constexpr char ScriptReserved_InitialiseCreature[]       = "InitialiseCreature";
