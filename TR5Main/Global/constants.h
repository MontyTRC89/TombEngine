...
#define LARA_DASH_LEAN_RATE ((ANGLE(1)/2) + ANGLE(1))
#define LARA_DASH_LEAN_MAX ANGLE(16)
#define LARA_DASH_TURN_RATE ((ANGLE(1)/4) + ANGLE(1))
#define LARA_DASH_TURN_MAX ANGLE(3)
#define STEPUP_HEIGHT ((STEP_SIZE*3)/2)
#define BAD_JUMP_CEILING ((STEP_SIZE*3)/4)
#define LARA_RAD 100
#define SWAMP_GRAVITY 2
#define VAULT_SWAMP_WARNING (STEP_SIZE*3)
#define VAULT_CLICK2 STEP_SIZE*2
#define VAULT_CLICK3 STEP_SIZE*3
#define VAULT_CLICKMAX_DOWN STEP_SIZE*4
#define VAULT_CLICKMAX STEP_SIZE*7
#define VAULT_CLICKMAX_WITHACTION STEP_SIZE*8
#define VAULT_LOWERTHANLARA STEP_SIZE*5 + LARA_HITE
#define VAULT_2CLICK_POS (-VAULT_CLICK2 + STEP_SIZE/2)
#define VAULT_2CLICK_NEG (-VAULT_CLICK2 - STEP_SIZE/2)
#define VAULT_3CLICK_POS (-VAULT_CLICK3 + STEP_SIZE/2)
#define VAULT_3CLICK_NEG (-VAULT_CLICK3 - STEP_SIZE/2)
#define VAULT_MAXCLICK_POS (-VAULT_CLICKMAX_DOWN + STEP_SIZE/2)
#define VAULT_MAXCLICK_NEG (-VAULT_CLICKMAX - STEP_SIZE/2)
#define VAULT_MAXCLICK_WITHACTION_POS (-VAULT_CLICKMAX_WITHACTION + STEP_SIZE/2)