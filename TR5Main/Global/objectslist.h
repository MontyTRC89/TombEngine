...
ID_TONYBOSS, // TR3 - 90% (need effect)
...
ID_MONK1, // TR2 - ON (Need to detect the mercenary)
ID_MONK2, // TR2 - ON (Need to detect the mercenary)
...
ID_MINECART_ANIMS, // TR3 - (Need Test)
ID_SOPHIA_LEE, // TR3 - (Need Test)
