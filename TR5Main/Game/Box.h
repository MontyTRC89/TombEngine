...
#define CreatureMood_Orig ((void (__cdecl*)(ITEM_INFO*, AI_INFO*, __int32)) 0x00409370)
#define GetCreatureMood_Orig ((void (__cdecl*)(ITEM_INFO*, AI_INFO*, __int32)) 0x004090A0)
...
#define CalculateTarget ((__int32(__cdecl*)(PHD_VECTOR*, ITEM_INFO*, LOT_INFO*)) 0x004098B0)
