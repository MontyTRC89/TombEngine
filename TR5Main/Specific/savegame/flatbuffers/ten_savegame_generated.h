...
struct Lara FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_MOVE_COUNT = 162,
    VT_LOCATION = 164,
    VT_HIGHEST_LOCATION = 166,
    VT_LOCATION_PAD = 168,
    VT_TIGHTROPE = 170,
    VT_BEETLE_LIFE = 172,
    VT_HAS_BEETLE_THINGS = 174,
    VT_SMALL_WATERSKIN = 176,
    VT_BIG_WATERSKIN = 178,
    VT_VEHICLE = 180,
    VT_EXTRA_ANIM = 182,
    VT_MINE_L = 184,
    VT_MINE_R = 186,
    ...
    VT_PICKUPS = 194,
    VT_EXAMINES = 196,
    VT_PUZZLES_COMBO = 198,
    VT_KEYS_COMBO = 200,
    VT_PICKUPS_COMBO = 202,
    VT_EXAMINES_COMBO = 204,
    VT_SECRETS = 206,
    VT_LASERSIGHT = 208,
    VT_CROWBAR = 210,
    VT_TORCH = 212,
    VT_SILENCER = 214,
    VT_BINOCULARS = 216,
    VT_NUM_LARGE_MEDIPACKS = 218,
    VT_NUM_SMALL_MEDIPACKS = 220,
    VT_NUM_FLARES = 222,
    VT_TARGET_ITEM_NUMBER = 224
  };
