...
struct LaraControlData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_LOCKED = 36,
    VT_RUN_JUMP_COUNT = 38,
    VT_POSITION_ADJUST_COUNT = 40,
    VT_POSE_COUNT = 42,
    VT_DIVE_COUNT = 44,
    VT_DEATH_COUNT = 46,
    VT_ROPE_CONTROL = 48,
    VT_TIGHTROPE_CONTROL = 50,
    VT_IS_BUSY = 52,
    VT_OLD_BUSY = 54
  };
...
struct Lara FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_LIT_TORCH = 58,
    VT_FIRED = 60,
    VT_WATER_SURFACE_DIST = 62,
    VT_LAST_POSITION = 64,
    VT_NEXT_CORNER_POSITION = 66,
    VT_NEXT_CORNER_ROTATION = 68,
    VT_MESH_PTRS = 70,
    VT_TARGET_ANGLES = 72,
    VT_LEFT_ARM = 74,
    VT_RIGHT_ARM = 76,
    VT_INTERACTED_ITEM = 78,
    VT_LOCATION = 80,
    VT_HIGHEST_LOCATION = 82,
    VT_LOCATION_PAD = 84,
    VT_BEETLE_LIFE = 86,
