...
struct Lara FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_DIVE_COUNT = 38,
    VT_DEATH_COUNT = 40,
    VT_CURRENT_ACTIVE = 42,
    VT_CURRENT_X_VEL = 44,
    VT_CURRENT_Y_VEL = 46,
    VT_CURRENT_Z_VEL = 48,
    VT_SPAZ_EFFECT_COUNT = 50,
    VT_FLARE_AGE = 52,
    VT_BURN_COUNT = 54,
    VT_WEAPON_ITEM = 56,
    VT_HOLSTER_INFO = 58,
    ...
    VT_BUSY = 86,
    VT_OLD_BUSY = 88,
    VT_UNCONTROLLABLE = 90,
    VT_LIT_TORCH = 92,
    VT_IS_CLIMBING = 94,
    VT_FIRED = 96,
    VT_WATER_SURFACE_DIST = 98,
    VT_LAST_POSITION = 100,
    VT_NEXT_CORNER_POSITION = 102,
    VT_NEXT_CORNER_ROTATION = 104,
    VT_MESH_PTRS = 106,
    VT_TARGET_ANGLES = 108,
    VT_TURN_RATE = 110,
    VT_MOVE_ANGLE = 112,
    VT_HEAD_X_ROT = 114,
    VT_HEAD_Y_ROT = 116,
    ...
    VT_RIGHT_ARM = 128,
    VT_ROPE_SEGMENT = 130,
    VT_ROPE_DIRECTION = 132,
    VT_ROPE_ARC_FRONT = 134,
    VT_ROPE_ARC_BACK = 136,
    VT_ROPE_LAST_X = 138,
    VT_ROPE_MAX_X_FORWARD = 140,
    VT_ROPE_MAX_X_BACKWARD = 142,
    VT_ROPE_DFRAME = 144,
    VT_ROPE_FRAME = 146,
    VT_ROPE_FRAMERATE = 148,
    VT_ROPE_Y = 150,
    VT_ROPE_PTR = 152,
    VT_INTERACTED_ITEM = 154,
    VT_ROPE_OFFSET = 156,
    VT_ROPE_DOWN_VEL = 158,
    VT_ROPE_FLAG = 160,
    VT_ROPE_COUNT = 162,
    VT_MOVE_COUNT = 164,
    VT_LOCATION = 166,
    VT_HIGHEST_LOCATION = 168,
    VT_LOCATION_PAD = 170,
    VT_TIGHTROPE = 172,
    VT_BEETLE_LIFE = 174,
    VT_HAS_BEETLE_THINGS = 176,
    VT_SMALL_WATERSKIN = 178,
    VT_BIG_WATERSKIN = 180,
    VT_VEHICLE = 182,
    VT_EXTRA_ANIM = 184,
    VT_MINE_L = 186,
    VT_MINE_R = 188,
    ...
    VT_PICKUPS = 196,
    VT_EXAMINES = 198,
    VT_PUZZLES_COMBO = 200,
    VT_KEYS_COMBO = 202,
    VT_PICKUPS_COMBO = 204,
    VT_EXAMINES_COMBO = 206,
    VT_SECRETS = 208,
    VT_LASERSIGHT = 210,
    VT_CROWBAR = 212,
    VT_TORCH = 214,
    VT_SILENCER = 216,
    VT_BINOCULARS = 218,
    VT_NUM_LARGE_MEDIPACKS = 220,
    VT_NUM_SMALL_MEDIPACKS = 222,
    VT_NUM_FLARES = 224,
    VT_TARGET_ITEM_NUMBER = 226
  };
