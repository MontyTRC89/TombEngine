...
void GuardControl(short itemNumber)
{
	...
	if (creature->FiredWeapon)
	{
		...
		PHD_VECTOR pos = { SwatGunBite.x, SwatGunBite.y, SwatGunBite.z };
...
void SniperControl(short itemNumber)
{
	...
	if (creature->FiredWeapon)
	{
		PHD_VECTOR pos = { SniperGunBite.x, SniperGunBite.y, SniperGunBite.z };
...
void Mafia2Control(short itemNumber)
{
	...
	if (creature->FiredWeapon)
	{
		PHD_VECTOR pos = { ArmedMafia2GunBite.x, ArmedMafia2GunBite.y, ArmedMafia2GunBite.z };
